...
pub use indracore_test_service::{
	Client, construct_extrinsic, construct_transfer_extrinsic, IndracoreTestExecutor, FullBackend,
};
pub use indracore_test_runtime as runtime;

/// Test client executor.
pub type Executor = client::LocalCallExecutor<FullBackend, sc_executor::NativeExecutor<IndracoreTestExecutor>>;
...
mod tests{
	...
	fn ensure_test_client_can_push_extrinsic() {
		...
		block_builder.push_indracore_extrinsic(transfer).expect("Pushes extrinsic");
