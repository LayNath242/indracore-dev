...
use indracore_primitives::v1::{ValidatorId, AccountId, AssignmentId};
use indracore_service::chain_spec::{get_account_id_from_seed, get_from_seed, Extensions};
use indracore_test_runtime::constants::currency::SELS;
...
pub type IndracoreChainSpec =
	service::GenericChainSpec<indracore_test_runtime::GenesisConfig, Extensions>;

/// Local testnet config (multivalidator Alice + Bob)
pub fn indracore_local_testnet_config() -> IndracoreChainSpec {
	IndracoreChainSpec::from_genesis(
		"Local Testnet",
		"local_testnet",
		ChainType::Local,
		|| indracore_local_testnet_genesis(),
		vec![],
		None,
...
pub fn indracore_local_testnet_genesis() -> indracore_test_runtime::GenesisConfig {
...
) -> indracore_test_runtime::GenesisConfig {
	use indracore_test_runtime as runtime;
