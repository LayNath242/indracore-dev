...
use indracore_node_network_protocol::{v1 as protocol_v1, PeerId, NetworkBridgeEvent, View, ReputationChange, OurView};
...
mod test {
	...
	use maplit::hashmap;
	use indracore_primitives::v1::{Signed, AvailabilityBitfield};
