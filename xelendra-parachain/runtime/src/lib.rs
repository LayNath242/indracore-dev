...
use primitives::{ 
	Index, Balance, Hash, AccountId, BlockNumber, Moment, Signature
};
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	...
	impl_name: create_runtime_str!("xelendra-parachain"),
	authoring_version: 1,
	spec_version: 3,
	impl_version: 1,
...
parameter_types! {
	pub const ExistentialDeposit: Balance = 500 * CENTS;
...
parameter_types! {
	pub const XelendraLocation: MultiLocation = MultiLocation::X1(Junction::Parent);
	pub const XelendraNetwork: NetworkId = NetworkId::Indracore;
...
type LocationConverter = (
	...
	AccountId32Aliases<XelendraNetwork, AccountId>,
);
...
type LocalOriginConverter = (
	...
	SignedAccountId32AsNative<XelendraNetwork, Origin>,
);
